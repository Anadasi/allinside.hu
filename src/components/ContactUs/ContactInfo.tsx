  ...
  const contactData: ContactInfoItem[] = [
    {
      ...
      title: "Email Support",
      content: "support@doutor.health",
      link: "mailto:support@doutor.health",
      linkType: "email",
    },
    {
      id: 2,
      ...
      content: "+1 (800) 456-7890",
      link: "tel:18004567890",
      linkType: "phone",
    },
    {
      id: 3,
      ...
      content: "123 Digital Health Blvd, Suite 100 San Francisco",
      linkType: "none",
    },
  ];

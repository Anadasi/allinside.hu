...
function PricingPlanTwo() {
  ...
  return (
    <>
      <div className="pricing-area ptb-140 smoke-bg-color">
        <div className="container">
          <div className="section-title">
            ...
            >
              <span className="sub wrap2">Our Pricing</span>
              <h2>Simple, Transparent Pricing - With or Without Insurance</h2>
            </div>
          </div>

...
import { handleBlogSearch } from "@/actions/blogActions"; // adjust path if needed
...
const Sidebar = () => {
  ...
  const categories = [
    { name: "Telehealth Tips", count: "07", link: "/blogs" },
    { name: "Mental Health", count: "10", link: "/blogs" },
    { name: "General Medicine", count: "05", link: "/blogs" },
    { name: "Lifestyle & Care", count: "03", link: "/blogs" },
  ];

  const tags = [
    { name: "VirtualCare", link: "/blogs" },
    { name: "MentalHealth", link: "/blogs" },
    { name: "OnlineTherapy", link: "/blogs" },
    { name: "ChronicCare", link: "/blogs" },
    { name: "HealthTips", link: "/blogs" },
    { name: "FamilyCare", link: "/blogs" },
  ];
  ...
  return (
    <div className="widget-area">
      ...
      <div className="widget widget_box">
        <div className="image">
          <Image src={widgetBoxData.image.src} alt={widgetBoxData.image.alt} width={60} height={66} />
        </div>

            ...
            <div className="col-xl-8 col-md-12">
              <div className="blog-details-desc">
                ...
                <div className="blog-details-content">
                  ...
                  <p>Our platform offers morning, evening, and weekend appointments to fit into any work schedule. Whether you&apos;re a full-time employee, freelancer, or shift worker, you can get care when it&apos;s convenient—not just when a clinic is open.</p>
                  ...
                  <div className="row justify-content-center align-items-center">
                    ...
                    <div className="col-lg-5 col-md-5">
                      <ul className="social">
                        ...
                        <li>
                          <a href="https://www.facebook.com/drmajzikerno/" target="_blank">
                            <Image
                        ...
                        <li>
                          <a href="https://www.linkedin.com/in/dr-majzik-erno/" target="_blank">
                            <Image
                        ...
                        <li>
                          <a href="https://www.instagram.com/dr.majzik.erno/" target="_blank">
                            <Image

...
const doctorData: DoctorProfileData = {
  ...
  socialLinks: [
    { platform: "facebook", url: "https://www.facebook.com/drmajzikerno", icon: "/images/icons/facebook.svg" },
    { platform: "linkedin", url: "https://www.linkedin.com/in/dr-majzik-erno/", icon: "/images/icons/linkedin.svg" },
    { platform: "instagram", url: "https://www.instagram.com/dr.majzik.erno/", icon: "/images/icons/instagram.svg" },
  ],
  ...
  experienceDetails: { yearsOfPractice: "30 év", previousInstitutions: [], specialClinicalFocus: [], languagesSpoken: ["Magyar"] },
  reviewsList: [],
};
                    ...
                    <ul className="left">
                      <li>
                        ...
                        <div className="rating-info">
                          <div className="list">{renderStars(doctorData.reviews.rating)}</div>
                ...
                <div className="profile-tabs">
                  <ul className="nav nav-tabs" id="myTab" role="tablist">
                    <li className="nav-item">
                      <button type="button" onClick={() => setActiveTab(1)} className={`nav-link ${activeTab === 1 ? "active" : ""}`}>
                        Bemutatkozás
                      </button>
                    </li>
                    <li className="nav-item">
                      <button type="button" onClick={() => setActiveTab(2)} className={`nav-link ${activeTab === 2 ? "active" : ""}`}>
                        Szakmai pályafutás
                      </button>
                    </li>
                    <li className="nav-item">
                      <button type="button" onClick={() => setActiveTab(3)} className={`nav-link ${activeTab === 3 ? "active" : ""}`}>
                        Hitvallás
                      </button>
                    </li>
                  </ul>
                  ...
                  <div className="tab-content">
                    {activeTab === 1 && (
                      <div className="about-tab-content pt-4">
                        <h4>Bemutatkozás</h4>
                        {doctorData.about.paragraphs.map((p, i) => <p key={i}>{p}</p>)}
                      </div>
                    )}
